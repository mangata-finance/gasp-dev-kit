...
export default {
  ...
  /**
   * Lookup48: pallet_rolldown::messages::RequestId
   **/
  ...
  /**
   * Lookup49: pallet_rolldown::messages::Origin
   **/
  PalletRolldownMessagesOrigin: {
    _enum: ['L1', 'L2']
  },
  /**
   * Lookup50: pallet_rolldown::pallet::BatchSource
   **/
  PalletRolldownBatchSource: {
    _enum: ['Manual', 'AutomaticSizeReached', 'PeriodReached']
  },
  /**
   * Lookup52: pallet_metamask_signature::pallet::Event<T>
   **/
  ...
  /**
   * Lookup61: pallet_transaction_payment_mangata::pallet::Event<T>
   **/
  ...
  /**
   * Lookup62: pallet_xyk::pallet::Event<T>
   **/
  PalletXykEvent: {
    _enum: {
  ...
  /**
   * Lookup65: pallet_proof_of_stake::pallet::Event<T>
   **/
  ...
  /**
   * Lookup66: pallet_fee_lock::pallet::Event<T>
   **/
  PalletFeeLockEvent: {
    _enum: {
  ...
  /**
   * Lookup67: pallet_vesting_mangata::pallet::Event<T>
   **/
  ...
  /**
   * Lookup68: pallet_crowdloan_rewards::pallet::Event<T>
   **/
  ...
  /**
   * Lookup69: pallet_issuance::pallet::Event<T>
   **/
  PalletIssuanceEvent: {
    _enum: {
  ...
  /**
   * Lookup70: pallet_issuance::IssuanceInfo<Balance>
   **/
  ...
  /**
   * Lookup72: pallet_issuance::TgeInfo<sp_runtime::account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup73: pallet_multipurpose_liquidity::pallet::Event<T>
   **/
  ...
  /**
   * Lookup74: pallet_bootstrap::pallet::Event<T>
   **/
  ...
  /**
   * Lookup75: parachain_staking::pallet::Event<T>
   **/
  ...
  /**
   * Lookup76: parachain_staking::pallet::CandidateBondRequest<Balance>
   **/
  ...
  /**
   * Lookup77: parachain_staking::pallet::CandidateBondChange
   **/
  ParachainStakingCandidateBondChange: {
    _enum: ['Increase', 'Decrease']
  },
  /**
   * Lookup78: parachain_staking::pallet::DelegationRequest<sp_runtime::account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup79: parachain_staking::pallet::DelegationChange
   **/
  ParachainStakingDelegationChange: {
    _enum: ['Revoke', 'Increase', 'Decrease']
  },
  /**
   * Lookup80: parachain_staking::pallet::DelegatorAdded<Balance>
   **/
  ...
  /**
   * Lookup81: parachain_staking::PayoutRounds
   **/
  ...
  /**
   * Lookup82: pallet_sequencer_staking::pallet::Event<T>
   **/
  ...
  /**
   * Lookup85: pallet_grandpa::pallet::Event
   **/
  PalletGrandpaEvent: {
    _enum: {
      NewAuthorities: {
  ...
  /**
   * Lookup88: sp_consensus_grandpa::app::Public
   **/
  SpConsensusGrandpaAppPublic: 'SpCoreEd25519Public',
  /**
   * Lookup89: sp_core::ed25519::Public
   **/
  SpCoreEd25519Public: '[u8;32]',
  /**
   * Lookup90: orml_asset_registry::module::Event<T>
   **/
  ...
  /**
   * Lookup91: orml_traits::asset_registry::AssetMetadata<Balance, mangata_types::assets::CustomMetadata, StringLimit>
   **/
  ...
  /**
   * Lookup92: mangata_types::assets::CustomMetadata
   **/
  ...
  /**
   * Lookup94: mangata_types::assets::XcmMetadata
   **/
  MangataTypesAssetsXcmMetadata: {
    feePerSecond: 'u128'
  },
  /**
   * Lookup96: mangata_types::assets::XykMetadata
   **/
  MangataTypesAssetsXykMetadata: {
    operationsDisabled: 'bool'
  },
  /**
   * Lookup99: staging_xcm::VersionedMultiLocation
   **/
  ...
  /**
   * Lookup100: staging_xcm::v2::multilocation::MultiLocation
   **/
  ...
  /**
   * Lookup101: staging_xcm::v2::multilocation::Junctions
   **/
  ...
  /**
   * Lookup102: staging_xcm::v2::junction::Junction
   **/
  ...
  /**
   * Lookup104: staging_xcm::v2::NetworkId
   **/
  ...
  /**
   * Lookup107: staging_xcm::v2::BodyId
   **/
  StagingXcmV2BodyId: {
    _enum: {
      Unit: 'Null',
  ...
  /**
   * Lookup108: staging_xcm::v2::BodyPart
   **/
  ...
  /**
   * Lookup110: staging_xcm::v3::junctions::Junctions
   **/
  ...
  /**
   * Lookup111: staging_xcm::v3::junction::Junction
   **/
  ...
  /**
   * Lookup113: staging_xcm::v3::junction::NetworkId
   **/
  ...
  /**
   * Lookup114: staging_xcm::v3::junction::BodyId
   **/
  ...
  /**
   * Lookup115: staging_xcm::v3::junction::BodyPart
   **/
  ...
  /**
   * Lookup116: pallet_treasury::pallet::Event<T, I>
   **/
  PalletTreasuryEvent: {
    _enum: {
      Proposed: {
  ...
  /**
   * Lookup117: pallet_sudo_mangata::pallet::Event<T>
   **/
  ...
  /**
   * Lookup144: pallet_utility_mangata::pallet::Call<T>
   **/
  ...
  /**
   * Lookup147: pallet_proxy::pallet::Call<T>
   **/
  PalletProxyCall: {
    _enum: {
      proxy: {
  ...
  /**
   * Lookup149: pallet_maintenance::pallet::Call<T>
   **/
  ...
  /**
   * Lookup150: pallet_rolldown::pallet::Call<T>
   **/
  PalletRolldownCall: {
    _enum: {
      update_l2_from_l1: {
  ...
  /**
   * Lookup151: pallet_rolldown::messages::L1Update
   **/
  ...
  /**
   * Lookup153: pallet_rolldown::messages::Deposit
   **/
  ...
  /**
   * Lookup157: pallet_rolldown::messages::CancelResolution
   **/
  ...
  /**
   * Lookup159: pallet_rolldown::messages::WithdrawalResolution
   **/
  ...
  /**
   * Lookup161: pallet_rolldown::messages::L2UpdatesToRemove
   **/
  ...
  /**
   * Lookup163: pallet_metamask_signature::pallet::Call<T>
   **/
  ...
  /**
   * Lookup164: orml_tokens::module::Call<T>
   **/
  ...
  /**
   * Lookup165: pallet_xyk::pallet::Call<T>
   **/
  PalletXykCall: {
    _enum: {
      create_pool: {
  ...
  /**
   * Lookup168: pallet_proof_of_stake::pallet::Call<T>
   **/
  ...
  /**
   * Lookup170: mangata_types::multipurpose_liquidity::ActivateKind
   **/
  MangataTypesMultipurposeLiquidityActivateKind: {
    _enum: ['AvailableBalance', 'StakedUnactivatedReserves', 'UnspentReserves']
  },
  /**
   * Lookup172: pallet_proof_of_stake::ThirdPartyActivationKind<CurrencyId>
   **/
  ...
  /**
   * Lookup173: pallet_fee_lock::pallet::Call<T>
   **/
  PalletFeeLockCall: {
    _enum: {
  ...
  /**
   * Lookup177: pallet_vesting_mangata::pallet::Call<T>
   **/
  ...
  /**
   * Lookup178: pallet_vesting_mangata::vesting_info::VestingInfo<Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup179: pallet_crowdloan_rewards::pallet::Call<T>
   **/
  ...
  /**
   * Lookup180: sp_runtime::account::EthereumSignature
   **/
  SpRuntimeAccountEthereumSignature: 'SpCoreEcdsaSignature',
  /**
   * Lookup181: sp_core::ecdsa::Signature
   **/
  SpCoreEcdsaSignature: '[u8;65]',
  /**
   * Lookup187: pallet_issuance::pallet::Call<T>
   **/
  PalletIssuanceCall: {
    _enum: {
  ...
  /**
   * Lookup189: pallet_multipurpose_liquidity::pallet::Call<T>
   **/
  ...
  /**
   * Lookup190: pallet_bootstrap::pallet::Call<T>
   **/
  PalletBootstrapCall: {
    _enum: {
      provision: {
  ...
  /**
   * Lookup192: parachain_staking::pallet::Call<T>
   **/
  ...
  /**
   * Lookup194: mangata_types::multipurpose_liquidity::BondKind
   **/
  MangataTypesMultipurposeLiquidityBondKind: {
    _enum: ['AvailableBalance', 'ActivatedUnstakedReserves', 'UnspentReserves']
  },
  /**
   * Lookup195: parachain_staking::pallet::PairedOrLiquidityToken<CurrencyId>
   **/
  ...
  /**
   * Lookup196: parachain_staking::MetadataUpdateAction
   **/
  ParachainStakingMetadataUpdateAction: {
    _enum: ['ExtendApprovedCollators', 'RemoveApprovedCollators']
  },
  /**
   * Lookup197: pallet_sequencer_staking::pallet::Call<T>
   **/
  ...
  /**
   * Lookup198: pallet_session::pallet::Call<T>
   **/
  PalletSessionCall: {
    _enum: {
      set_keys: {
  ...
  /**
   * Lookup199: rollup_runtime::SessionKeys
   **/
  ...
  /**
   * Lookup208: sp_core::ed25519::Signature
   **/
  ...
  SpCoreVoid: 'Null',
  /**
   * Lookup215: orml_asset_registry::module::Call<T>
   **/
  ...
  /**
   * Lookup219: mangata_types::assets::L1Asset
   **/
  ...
  /**
   * Lookup222: pallet_sudo_mangata::pallet::Call<T>
   **/
  ...
  /**
   * Lookup223: pallet_sudo_origin::pallet::Call<T>
   **/
  ...
  /**
   * Lookup224: pallet_collective_mangata::pallet::Call<T, I>
   **/
  ...
  /**
   * Lookup266: rollup_runtime::OriginCaller
   **/
  ...
  /**
   * Lookup267: frame_support::dispatch::RawOrigin<sp_runtime::account::AccountId20>
   **/
  ...
  /**
   * Lookup268: pallet_collective_mangata::RawOrigin<sp_runtime::account::AccountId20, I>
   **/
  ...
  /**
   * Lookup269: pallet_utility_mangata::pallet::Error<T>
   **/
  PalletUtilityMangataError: {
    _enum: ['TooManyCalls']
  },
  /**
   * Lookup272: pallet_proxy::ProxyDefinition<sp_runtime::account::AccountId20, rollup_runtime::runtime_config::config::pallet_proxy::ProxyType, BlockNumber>
   **/
  ...
  /**
   * Lookup276: pallet_proxy::Announcement<sp_runtime::account::AccountId20, primitive_types::H256, BlockNumber>
   **/
  ...
  /**
   * Lookup279: pallet_maintenance::pallet::MaintenanceStatusInfo
   **/
  ...
  /**
   * Lookup280: pallet_maintenance::pallet::Error<T>
   **/
  ...
  /**
   * Lookup288: pallet_rolldown::pallet::SequencerRights
   **/
  ...
  /**
   * Lookup293: pallet_rolldown::pallet::L2Request<sp_runtime::account::AccountId20>
   **/
  ...
  /**
   * Lookup294: pallet_rolldown::pallet::RequestResult
   **/
  ...
  /**
   * Lookup295: pallet_rolldown::messages::eth_abi::UpdateType
   **/
  ...
  /**
   * Lookup296: pallet_rolldown::pallet::Cancel<sp_runtime::account::AccountId20>
   **/
  ...
  /**
   * Lookup297: pallet_rolldown::pallet::Withdrawal
   **/
  ...
  /**
   * Lookup314: orml_tokens::AccountData<Balance>
   **/
  ...
  /**
   * Lookup316: orml_tokens::ReserveData<ReserveIdentifier, Balance>
   **/
  ...
  /**
   * Lookup318: orml_tokens::module::Error<T>
   **/
  ...
  /**
   * Lookup320: pallet_transaction_payment_mangata::Releases
   **/
  PalletTransactionPaymentMangataReleases: {
    _enum: ['V1Ancient', 'V2']
  },
  /**
   * Lookup322: pallet_xyk::pallet::Error<T>
   **/
  PalletXykError: {
  ...
  /**
   * Lookup323: pallet_proof_of_stake::reward_info::RewardInfo<Balance>
   **/
  ...
  /**
   * Lookup325: pallet_proof_of_stake::pallet::PromotedPools
   **/
  ...
  /**
   * Lookup329: pallet_proof_of_stake::schedule_rewards_calculator::ScheduleRewards<Balance>
   **/
  ...
  /**
   * Lookup336: pallet_proof_of_stake::SchedulesList
   **/
  ...
  /**
   * Lookup338: pallet_proof_of_stake::Schedule<T>
   **/
  ...
  /**
   * Lookup339: pallet_proof_of_stake::schedule_rewards_calculator::ActivatedLiquidityPerSchedule<Balance>
   **/
  ...
  /**
   * Lookup341: pallet_proof_of_stake::pallet::Error<T>
   **/
  ...
  /**
   * Lookup342: pallet_fee_lock::pallet::FeeLockMetadataInfo<T>
   **/
  ...
  /**
   * Lookup345: pallet_fee_lock::pallet::AccountFeeLockDataInfo<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup346: pallet_fee_lock::pallet::Error<T>
   **/
  PalletFeeLockError: {
  ...
  /**
   * Lookup349: pallet_vesting_mangata::Releases
   **/
  PalletVestingMangataReleases: {
    _enum: ['V0', 'V1']
  },
  /**
   * Lookup350: pallet_vesting_mangata::pallet::Error<T>
   **/
  ...
  /**
   * Lookup352: pallet_crowdloan_rewards::pallet::RewardInfo<T>
   **/
  ...
  /**
   * Lookup353: pallet_crowdloan_rewards::pallet::Error<T>
   **/
  ...
  /**
   * Lookup355: pallet_issuance::pallet::Error<T>
   **/
  PalletIssuanceError: {
  ...
  /**
   * Lookup356: pallet_multipurpose_liquidity::pallet::ReserveStatusInfo<Balance>
   **/
  ...
  /**
   * Lookup358: pallet_multipurpose_liquidity::pallet::RelockStatusInfo<Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup360: pallet_multipurpose_liquidity::pallet::Error<T>
   **/
  ...
  /**
   * Lookup362: pallet_bootstrap::BootstrapPhase
   **/
  ...
  /**
   * Lookup367: pallet_bootstrap::pallet::Error<T>
   **/
  ...
  /**
   * Lookup368: parachain_staking::pallet::RoundInfo<BlockNumber>
   **/
  ...
  /**
   * Lookup369: parachain_staking::pallet::Delegator<sp_runtime::account::AccountId20, Balance, CurrencyId>
   **/
  ...
  /**
   * Lookup370: parachain_staking::set::OrderedSet<parachain_staking::pallet::Bond<sp_runtime::account::AccountId20, Balance, CurrencyId>>
   **/
  ParachainStakingSetOrderedSetBond: 'Vec<ParachainStakingBond>',
  /**
   * Lookup371: parachain_staking::pallet::Bond<sp_runtime::account::AccountId20, Balance, CurrencyId>
   **/
  ...
  /**
   * Lookup373: parachain_staking::pallet::PendingDelegationRequests<sp_runtime::account::AccountId20, Balance>
   **/
  ParachainStakingPendingDelegationRequests: {
    requests: 'BTreeMap<SpRuntimeAccountAccountId20, ParachainStakingDelegationRequest>'
  },
  /**
   * Lookup377: parachain_staking::pallet::DelegatorStatus
   **/
  ...
  /**
   * Lookup378: parachain_staking::pallet::CollatorCandidate<sp_runtime::account::AccountId20, Balance, CurrencyId>
   **/
  ...
  /**
   * Lookup379: parachain_staking::set::OrderedSet<sp_runtime::account::AccountId20>
   **/
  ParachainStakingSetOrderedSetAccountId20: 'Vec<SpRuntimeAccountAccountId20>',
  /**
   * Lookup381: parachain_staking::pallet::CollatorStatus
   **/
  ...
  /**
   * Lookup382: parachain_staking::pallet::CollatorSnapshot<sp_runtime::account::AccountId20, Balance, CurrencyId>
   **/
  ...
  /**
   * Lookup389: parachain_staking::pallet::AggregatorMetadataType<sp_runtime::account::AccountId20, CurrencyId>
   **/
  ...
  /**
   * Lookup399: parachain_staking::pallet::RoundCollatorRewardInfoType<sp_runtime::account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup400: parachain_staking::pallet::Error<T>
   **/
  ...
  /**
   * Lookup411: pallet_sequencer_staking::pallet::Error<T>
   **/
  ...
  /**
   * Lookup420: pallet_grandpa::StoredState<N>
   **/
  ...
  /**
   * Lookup421: pallet_grandpa::StoredPendingChange<N, Limit>
   **/
  ...
  /**
   * Lookup424: orml_asset_registry::module::Error<T>
   **/
  ...
  /**
   * Lookup425: pallet_treasury::Proposal<sp_runtime::account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup428: pallet_sudo_mangata::pallet::Error<T>
   **/
  PalletSudoMangataError: {
    _enum: ['RequireSudo']
  },
  /**
   * Lookup429: pallet_sudo_origin::pallet::Error<T>
   **/
  PalletSudoOriginError: 'Null',
  /**
   * Lookup431: pallet_collective_mangata::Votes<sp_runtime::account::AccountId20, BlockNumber>
   **/
  ...
  /**
   * Lookup432: pallet_collective_mangata::pallet::Error<T, I>
   **/
  ...
  /**
   * Lookup433: pallet_identity::types::Registration<Balance, MaxJudgements, MaxAdditionalFields>
   **/
  ...
  /**
   * Lookup441: pallet_identity::types::RegistrarInfo<Balance, sp_runtime::account::AccountId20>
   **/
  ...
  /**
   * Lookup443: pallet_identity::pallet::Error<T>
   **/
  PalletIdentityError: {
  ...
  /**
   * Lookup453: pallet_transaction_payment_mangata::ChargeTransactionPayment<T>
   **/
  ...
  /**
   * Lookup455: rollup_runtime::Runtime
   **/
