...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletRolldownL2Request (292) */
  ...
  /** @name PalletRolldownRequestResult (293) */
  ...
  /** @name PalletRolldownMessagesEthAbiUpdateType (294) */
  ...
  /** @name PalletRolldownWithdrawal (296) */
  ...
  /** @name PalletRolldownDisputeRole (300) */
  ...
  /** @name OrmlTokensReserveData (315) */
  interface OrmlTokensReserveData extends Struct {
    readonly id: U8aFixed;
    readonly amount: u128;
  }

  /** @name OrmlTokensModuleError (317) */
  ...
  /** @name PalletTransactionPaymentMangataReleases (319) */
  ...
  /** @name PalletProofOfStakeRewardInfo (322) */
  ...
  /** @name PalletProofOfStakePromotedPools (324) */
  interface PalletProofOfStakePromotedPools extends Struct {
    readonly weight: u8;
    readonly rewards: U256;
  }

  /** @name PalletProofOfStakeScheduleRewardsCalculatorScheduleRewards (328) */
  ...
  /** @name PalletProofOfStakeSchedulesList (335) */
  ...
  /** @name PalletProofOfStakeSchedule (337) */
  ...
  /** @name PalletProofOfStakeScheduleRewardsCalculatorActivatedLiquidityPerSchedule (338) */
  ...
  /** @name PalletProofOfStakeError (340) */
  ...
  /** @name PalletFeeLockFeeLockMetadataInfo (341) */
  ...
  /** @name PalletFeeLockAccountFeeLockDataInfo (344) */
  ...
  /** @name PalletVestingMangataReleases (348) */
  ...
  /** @name PalletVestingMangataError (349) */
  ...
  /** @name PalletCrowdloanRewardsRewardInfo (351) */
  ...
  /** @name PalletCrowdloanRewardsError (352) */
  ...
  /** @name PalletMultipurposeLiquidityReserveStatusInfo (355) */
  ...
  /** @name PalletMultipurposeLiquidityRelockStatusInfo (357) */
  ...
  /** @name PalletMultipurposeLiquidityError (359) */
  ...
  /** @name PalletBootstrapBootstrapPhase (361) */
  ...
  /** @name FrameSupportPalletId (365) */
  interface FrameSupportPalletId extends U8aFixed {}

  /** @name PalletBootstrapError (366) */
  ...
  /** @name ParachainStakingDelegator (368) */
  ...
  /** @name ParachainStakingPendingDelegationRequests (372) */
  ...
  /** @name ParachainStakingDelegatorStatus (376) */
  ...
  /** @name ParachainStakingCollatorCandidate (377) */
  ...
  /** @name ParachainStakingCollatorSnapshot (381) */
  ...
  /** @name ParachainStakingAggregatorMetadataType (388) */
  ...
  /** @name ParachainStakingRoundCollatorRewardInfoType (398) */
  ...
  /** @name ParachainStakingError (399) */
  ...
  /** @name PalletSequencerStakingError (410) */
  ...
  /** @name OrmlAssetRegistryModuleError (423) */
  ...
  /** @name PalletIdentityRegistration (432) */
  ...
  /** @name PalletIdentityRegistrarInfo (440) */
  ...
  /** @name FrameSystemExtensionsCheckSpecVersion (445) */
  type FrameSystemExtensionsCheckSpecVersion = Null;

  /** @name FrameSystemExtensionsCheckTxVersion (446) */
  ...
  /** @name PalletTransactionPaymentMangataChargeTransactionPayment (452) */
